...
namespace FoodFun.Infrastructure.Data.Migrations
{
    ...
    partial class FoodFunDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodFun.Infrastructure.Data.Models.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodFun.Infrastructure.Data.Models.UserAddress", b =>
                {
                    b.Property<string>("UserId")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("FoodFun.Infrastructure.Data.Models.Dish", b =>
                {
                    b.HasOne("FoodFun.Infrastructure.Data.Models.DishCategory", "Category")
                        .WithMany("Dishes")
            ...
            modelBuilder.Entity("FoodFun.Infrastructure.Data.Models.Order", b =>
                {
                    b.HasOne("FoodFun.Infrastructure.Data.Models.Address", "Address")
                        .WithMany("Orders")
                        .HasForeignKey("AddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FoodFun.Infrastructure.Data.Models.User", "User")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("FoodFun.Infrastructure.Data.Models.OrderDish", b =>
                {
                    b.HasOne("FoodFun.Infrastructure.Data.Models.Dish", "Dish")
                        .WithMany("DishInOrders")
                        .HasForeignKey("DishId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FoodFun.Infrastructure.Data.Models.Order", "Order")
            ...
            modelBuilder.Entity("FoodFun.Infrastructure.Data.Models.OrderProduct", b =>
                {
                    ...
                    b.HasOne("FoodFun.Infrastructure.Data.Models.Product", "Product")
            ...
            modelBuilder.Entity("FoodFun.Infrastructure.Data.Models.Product", b =>
                {
                    b.HasOne("FoodFun.Infrastructure.Data.Models.ProductCategory", "Category")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FoodFun.Infrastructure.Data.Models.Reservation", b =>
                {
                    b.HasOne("FoodFun.Infrastructure.Data.Models.Table", "Table")
            ...
            modelBuilder.Entity("FoodFun.Infrastructure.Data.Models.ReservationDish", b =>
                {
                    ...
                    b.HasOne("FoodFun.Infrastructure.Data.Models.Reservation", "Reservation")
            ...
            modelBuilder.Entity("FoodFun.Infrastructure.Data.Models.Table", b =>
                {
                    b.HasOne("FoodFun.Infrastructure.Data.Models.TablePosition", "TablePosition")
                        .WithMany("Tables")
                        .HasForeignKey("TablePositionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FoodFun.Infrastructure.Data.Models.TableSize", "TableSize")
                        .WithMany("Tables")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FoodFun.Infrastructure.Data.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
